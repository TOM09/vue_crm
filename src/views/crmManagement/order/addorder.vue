    ...
    <el-card>
      ...
      <el-form :model="ruleForm" ref="ruleForm" label-position="right" label-width="180px">
        <el-form-item class="" label="关联项目(必填)" prop="project_id">
          <el-input class="s_additem_btn" @focus.prevent="dialogFollow" v-model="project_name" placeholder="请选择"></el-input>
      ...
      <el-dialog :title="flowTitle" :visible.sync="ProcessVisible" :modal="false" width="70%">
        <el-form ref="formAdd" :model="formAdd">

          <el-form-item class='searchsome'>
            <el-input v-model="formAdd.code" clearable placeholder="请输入项目编号" class="addInput"></el-input>
          </el-form-item>

          <el-form-item class='searchsome'>          
            <el-input v-model="formAdd.projectName" clearable placeholder="请输入项目名称" class="addInput"></el-input>
          </el-form-item>

          <el-form-item class='searchsome'>          
            <el-input v-model="formAdd.client" clearable placeholder="请输入客户名称" class="addInput"></el-input>
          </el-form-item>  

          <el-form-item class='searchsome searchsome222'> 
            <el-select  v-model="formAdd.stage" placeholder="请选择项目状态"  class="addInput" clearable>
                <el-option
          ...
          <el-form-item class='searchsome2'> 
            <el-checkbox label="显示签约和流单项目" name="type" v-model="formAdd.checkboxStage" class="addInput addInput2"></el-checkbox>
          </el-form-item>          
          

          <el-button class='searchsome22' type="primary" @click="dialogFollow('formAdd')">查询</el-button>
        </el-form>
        <el-table :data="tableData" style="width: 100%;padding-top: 30px;" @row-click="handleClick">
...
//        弹窗分页
    ...
    methods: {
      ...
      handleClick(row) {
        ...
        this.ruleForm.trench = row.trench_arr;
        this.project_name = row.name;
        this.ProcessVisible = false;
      },
      // 关联客户弹出弹窗
      dialogFollow(){
        if(this.formAdd.checkboxStage){
          this.formAdd.is_contract_not = 1;
        }else{
          this.formAdd.is_contract_not = 0;
        }
        this.formAdd.currentPage = 1;
        this.ProcessVisible = true;
        this.$get("crmManagement/item/itemList",this.formAdd)
          .then((data)=>{
             this.itemState = data.content.stage;
            this.tableData = data.content.projectList;
     ...
     accAdd(arg1, arg2) {
      ...
      fetchData() {
        ...
        this.project_name = this.$route.params.name ? this.$route.params.name : '';
      }
    },
    watch: {
      '$route' : 'fetchData'
